...
class FollowerCell: UICollectionViewCell {
    ...
    // UI Elements
    var avatarImageView         = TFAvatarImageView(frame: .zero)
    let usernameLabel           = TFTitleLabel(textAlignment: .center, fontSize: DeviceTypes.isiPhoneSE || DeviceTypes.isiPhone8Zoomed ? 14 : 16, frame: .zero)
