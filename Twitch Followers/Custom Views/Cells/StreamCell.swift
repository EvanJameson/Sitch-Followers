...
class StreamCell: UITableViewCell {
    ...
    // UI Elements
    let thumbnailImageView      = TFThumbnailImageView(frame: .zero)
    var viewerCountView         = TFViewerCountView(frame: .zero)
    let channelStatusImageView  = TFChannelStatusImageView(frame: .zero)
    let avatarImageView         = TFAvatarImageView(frame: .zero)
    let streamerLabel           = TFTitleLabel(textAlignment: .left, fontSize: 24, frame: .zero)
    let gameTitleLabel          = TFSecondaryTitleLabel(textAlignment: .left, fontSize: 16, frame: .zero)
    let streamTitleLabel        = TFSecondaryTitleLabel(textAlignment: .left, fontSize: 16, frame: .zero)
