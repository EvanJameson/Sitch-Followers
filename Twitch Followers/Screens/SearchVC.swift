...
class SearchVC: UIViewController {
    ...
    let usernameTextField = TFTextField()
    let callToActionButton = TFButton()
    ...
    func configureUIElements() {
        ...
        logoImageView.image = Images.twitchLogo
        
        usernameTextField.delegate = self
        
        callToActionButton.addTarget(self, action: #selector(pushFollowerListVC), for: .touchUpInside)
        callToActionButton.set(backgroundColor: .systemPurple, title: "Find Streamer")
    }
    ...
    func layoutUI() {
        ...
        let logoImageViewConstraints = [
            ...
            "logoImageView heightConstraint"        : logoImageView.heightAnchor.constraint(equalToConstant: 284),
            "logoImageView widthConstraint"         : logoImageView.widthAnchor.constraint(equalToConstant: 284)
        ]
        let userNameTextFieldConstraints = [
            "usernameTextField topConstraint"       : usernameTextField.topAnchor.constraint(equalTo: logoImageView.bottomAnchor, constant: 30),
