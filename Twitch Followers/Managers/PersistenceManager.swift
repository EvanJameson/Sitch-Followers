...
enum PersistenceManager {
    ...
    static func updateWith(favorite: User, actionType: PersistenceActionType, completed: @escaping(TFError?) -> Void) {
    ...
    static func retrieveFavorites(completed: @escaping(Result<[User], TFError>) -> Void) {
    ...
    static func save(favorites: [User]) -> TFError? {
        do {
