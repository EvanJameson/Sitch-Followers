...
class NetworkManager {
    ...
    func getUser(for username: String, completed: @escaping (Result<User, SError>) -> Void) {
    ...
    ///   - completed: completion handler/closure that returns a Result Type
    func getFollowers(for id: String, paginationCursor: String?, completed: @escaping (Result<FollowerWrapper, SError>) -> Void) {
    ...
    ///   - completed: completion handler/closure that returns a Result Type
    func getChannel(for username: String, completed: @escaping (Result<Channel, SError>) -> Void) {
    ...
    ///   - completed: completion handler/closure that returns a Result Type
    func getGameInfo(for id: String, completed: @escaping (Result<Game, SError>) -> Void) {
    ...
    ///   - completed: completion handler/closure that returns a Result Type
    func getStreams(paginationCursor: String?, completed: @escaping (Result<StreamWrapper,SError>) -> Void) {
